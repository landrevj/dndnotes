...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference('Campaign.count') do
      post campaigns_url, params: { campaign: { about: @campaign.about, name: @campaign.name } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { about: @campaign.about, name: @campaign.name } }
